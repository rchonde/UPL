...
export class DashboardComponent implements OnInit {
  ...
  public GetActivityList() {
    this.activityChartData=[];
      const apiUrl=this._global.baseAPIUrl+'Status/GetActivityCount?userID=0&user_Token='+localStorage.getItem('User_Token')
      this._onlineExamService.getAllData(apiUrl).subscribe((data: {}) => {     
...
public GetFileUploadList() {
 ...
 // const apiUrl=this._global.baseAPIUrl+'Status/GetDashboardData?user_Token='+this.DashboardForm.get('User_Token').value
 const apiUrl=this._global.baseAPIUrl+'Status/GetDashboardFileData?userID=0&user_Token='+localStorage.getItem('User_Token')
 this._onlineExamService.getAllData(apiUrl).subscribe((data: {}) => {     
  //console.log("data",data);
  this._UploadList =data;
   this._UploadList.forEach( (upload) => {
  ...
  this);
  this.chartFirstFU.data=this.firstChartDataFU;
});
// console.log("firstChart",this.firstChartData);
...
public GetActivityLog() {
  this.activitylogChartData=[];
    const apiUrl=this._global.baseAPIUrl+'Status/GetActivityUserLog?userID=0&user_Token='+localStorage.getItem('User_Token')
    this._onlineExamService.getAllData(apiUrl).subscribe((data: {}) => {     

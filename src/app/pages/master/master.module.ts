...
@NgModule({
  declarations: [DepartmentComponent, BranchMappingComponent,BranchComponent,TemplateComponent,DocumentTypeComponent,DocTypeMappingComponent,ViewCustomFormComponent,AddFieldComponent,TemplateMappingComponent,TemplateconfigComponent,RegionMappingComponent],
  imports: [
    CommonModule,

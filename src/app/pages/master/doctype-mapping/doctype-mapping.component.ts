...
export class DocTypeMappingComponent implements OnInit {
  ...
  _FilteredList: [];
  modalRef: BsModalRef;
  DocTypeMappingForm: UntypedFormGroup;
  AddDocTypeMappingForm: UntypedFormGroup;
  submitted = false;
  Reset = false;
  sMsg: string = "";
  _userid: any = 0;
  ...
  checkbox_list = [];
  itemRows: any;
  get checklistArray() { return this.AddDocTypeMappingForm.get('checklist') as UntypedFormArray; }
  constructor(

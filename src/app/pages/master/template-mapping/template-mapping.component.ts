...
export class TemplateMappingComponent implements OnInit {
  ...
  _TemplateID: any = 0;
  modalRef: BsModalRef;
  TemplateMappingForm: UntypedFormGroup;
  AddTemplateMappingForm: UntypedFormGroup;
  submitted = false;
  Reset = false;
  sMsg: string = "";
  _userid: any = 0;
  ...
  checkbox_list = [];
  itemRows: any;
  get checklistArray() { return this.AddTemplateMappingForm.get('checklist') as UntypedFormArray; }
  constructor(
